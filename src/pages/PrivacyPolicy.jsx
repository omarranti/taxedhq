...
const C = { primary: "#34D399", bg: "#0A0A12", surface: "rgba(255,255,255,0.06)", border: "rgba(255,255,255,0.1)", text: "#FFFFFF", textSec: "rgba(255,255,255,0.58)", muted: "rgba(255,255,255,0.32)" };
